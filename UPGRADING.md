...
- The safe upgrade unit today is a tagged release, for example `v2026.04.17 -> v2026.04.19`.
...
git switch -c codex/upgrade-v2026.04.19
git log --oneline --left-right --cherry-pick origin/main...upstream/main
pnpm upgrade:diff -- --from v2026.04.17 --to v2026.04.19
```
...
diff -ru ../aither-v2026.04.17 ../aither-v2026.04.19
```
